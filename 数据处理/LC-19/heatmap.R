data = read.csv("/public/home/yuwenqi/sc-data/selected/19/percent/percent_plotdata.csv", row.names=1)
...
heatmap = pheatmap(data, 
 ...
 pdf("/public/home/yuwenqi/sc-data/selected/19/percent/percent_heatmap/percent_corr_19.pdf", width = 25, height = 25)
 heatmap
 dev.off()