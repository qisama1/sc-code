# 按照差异基因选
```python
meta = pd.read_csv("/public/home/yuwenqi/sc-data/selected/9/b_info2.csv", index_col = 0)
b_res = pd.read_csv("/public/home/yuwenqi/sc-data/selected/9/bcell/b_res.csv", index_col=0, encoding = 'gbk')
marker = pd.read_csv("/public/home/yuwenqi/sc-data/selected/9/bcell/bcell-res0.8.csv")
...
for i in sg.columns:
    ...
    res.to_csv("/public/home/yuwenqi/sc-data/selected/9/bcell/9_b_score/"+ i + "_pct.csv")
```