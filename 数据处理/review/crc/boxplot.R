...
setwd("/public/home/yuwenqi/sc-data/selected/review/crc/tumor_normal_boxplot/")
fs = list.files('./', 'csv')
lapply(fs, function(x) {
    ...
    ggsave(paste0("/public/home/yuwenqi/sc-data/selected/review/crc/tumor_normal_boxplot/plot/",filename, ".pdf"), width = 10, height = 2.6, units = 'in')
