...
gene_sub = gene.loc[gene.type == 'BC']
...
for idx in gene_sub.index:
    ...
    p.to_csv("/public/home/yuwenqi/sc-data/selected/target-analysis-0403/CRC/os/" + gene_a + "_os.csv")
    p = pd.DataFrame(tcga_use.loc[:, [gene_b]])
    p = pd.concat([p, os_res], axis=1)
    p.to_csv("/public/home/yuwenqi/sc-data/selected/target-analysis-0403/CRC/os/" + gene_b + "_os.csv")
```
