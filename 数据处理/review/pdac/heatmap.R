data = read.csv("/public/home/yuwenqi/sc-data/selected/review/pdac/heatmap_plot_data.csv", row.names=1)
data = t(data)
...
pdf("/public/home/yuwenqi/sc-data/selected/review/pdac/gene_exp_cluster_heatmap_modified.pdf", width = 6, height = 15)
heatmap
dev.off()