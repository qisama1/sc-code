```python
gene_df = pd.read_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/gene_df.csv", index_col = 0).T
...
gene_corr = pd.read_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_an_sheet/gene_corr.csv")
# T
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_an_sheet/pathway_corr/epi_corr.csv")
idx = gsva_epi.index[gsva_epi.index.isin(meta_t.index)]
gene_df.loc[idx, gene_corr['Epi'].dropna()].corr('spearman').to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_an_sheet/pathway_corr/epi_gene_corr.csv")
# Mye
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_an_sheet/pathway_corr/mye_corr.csv")
idx = gsva_mye.index[gsva_mye.index.isin(meta_t.index)]
gene_df.loc[idx, gene_corr['Mye'].dropna()].corr('spearman').to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_an_sheet/pathway_corr/mye_gene_corr.csv")
# CAF
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_an_sheet/pathway_corr/caf_corr.csv")
idx = gsva_caf.index[gsva_caf.index.isin(meta_t.index)]
gene_df.loc[idx, gene_corr['CAF'].dropna()].corr('spearman').to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_an_sheet/pathway_corr/caf_gene_corr.csv")
# End
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_an_sheet/pathway_corr/epi_proliferation_corr.csv")
idx = gsva_all.index[gsva_all.index.isin(meta_t.index)]
gene_df.loc[idx, gene_corr['Epi'].dropna()].corr('spearman').to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_an_sheet/pathway_corr/epi_proliferation_gene_corr.csv")
```