...
gene = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/subTME_heatmap/pdac/an_pair.csv")
write.csv(as.matrix(scRNA[gene$gene, ]@assays$RNA@data), "/public/home/yuwenqi/sc-data/selected/append_ana/subTME_heatmap/pdac/gene_df.csv")
```

```py
# 1. 获取每行，然后判断类型，做一个简单的if/else即可，对于不同的类型对应不同的细胞类型的group
data = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/subTME_heatmap/pdac/gene_df.csv", index_col = 0).T
...
gene_used = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/subTME_heatmap/pdac/an_pair.csv")
...
idxs =  ['subTME-IS', 'myCAF', 'Proliferation', 'Proliferation', 'pEMT',
       'angiogenic EC', 'CAF_COL1A1', 'CAF_COL1A2', 'CAF_COL6A1', 'CAF_COL6A2',
       'CAF_COL6A3', 'CAF_FN1', 'CAF_LAMA4', 'CAF_LAMB1', 'CAF_LAMC1',
       'CAF_NAMPT', 'CAF_THBS1', 'CAF_THBS2', 'CAF_THY1', 'Epi_ITGA2',
       'Epi_ITGA3', 'Epi_ITGB1', 'Epi_SDC1', 'Epi_SDC4', 'TAM_ITGA6',
       'TAM_ITGAM', 'TAM_ITGAX', 'TAM_ITGB1', 'TAM_ITGB2']
...
pd.read_csv("/public/home/yuwenqi/sc-data/selected/35/module/cluster_sg_scores/s_celltype_gene_type.csv", index_col = 0).loc[:, ['type']].to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/subTME_heatmap/pdac/an.csv")
```