...
an_gene = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/4-12-tcga_heatmap-1/CRC/an_gene.csv")
...
basic_res[~basic_res.index.duplicated()].to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/4-12-tcga_heatmap-1/CRC/heatmap_data.csv")
res.loc[:, ['type']].to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/4-12-tcga_heatmap-1/CRC/an.csv")