...
data = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/gsva_an/bc/plot_data.csv", row.names=1)
setwd("/public/home/yuwenqi/sc-data/selected/append_ana/gsva_an/bc/")
...
p1 = ggplot(data,aes(x=subTME,y=Checkpoint.molecules),fill=subTME)+
    ...
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Checkpoint.molecules']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Myeloid.cells.traffic),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Myeloid.cells.traffic']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Macrophage.and.DC.traffic),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Macrophage.and.DC.traffic']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Matrix.remodeling),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Matrix.remodeling']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Angiogenesis),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Angiogenesis']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Tumor.proliferation),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Tumor.proliferation']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Epithelial.cells),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Epithelial.cells']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=T.cell.Exhaustion),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['T.cell.Exhaustion']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Interferon.endothelial.cells),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Interferon.endothelial.cells']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Angiogenic.endothelial.cells),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Angiogenic.endothelial.cells']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=pEMT),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['pEMT']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=myCAF),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['myCAF']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Anti.inflammatory.in.T.cells),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Anti.inflammatory.in.T.cells']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Anergy.in.T.cells),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Anergy.in.T.cells']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Pro.inflammatory.in.T.cells),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Pro.inflammatory.in.T.cells']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=M1.Macrophage.Polarization),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['M1.Macrophage.Polarization']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=M2.Macrophage.Polarization),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['M2.Macrophage.Polarization']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Pro.inflammatory.in.myeloid.cells),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Pro.inflammatory.in.myeloid.cells']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
...
p1 = ggplot(data,aes(x=subTME,y=Anti.inflammatory.in.myeloid.cells),fill=subTME)+
    ...
    #coord_cartesian(ylim = c(0, 2))+
    stat_compare_means(aes(group=subTME), symnum.args=list(cutpoints = c(0, 0.001, 0.01, 0.05, 1), symbols = c("***", "**", "*", " ")),
                        label = "p.signif", method='kruskal.test', label.x = 0.55, label.y = max(data['Anti.inflammatory.in.myeloid.cells']) - 0.013)  #+ stat_summary(aes(group=type), fun='mean', geom="point")
