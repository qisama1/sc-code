...
data = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/PDAC/module/tpm-compare/tpm_module_type.csv", row.names=1)
...
ggsave(filename = "./pdac_module_type.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
