...
tcga_use = tcga.loc[meta.index, gene.ESCA.dropna()]
tcga_use2 = tcga.loc[meta.index, gene2.ESCA.dropna()]
...
for gene in tcga_use.columns:
    ...
    p.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/TCGA/ESCA/os/" + gene + "_os.csv")

for gene in tcga_use2.columns:
    p = pd.DataFrame(tcga_use2.loc[:, [gene]])
    p = pd.concat([p, os_res], axis=1)
    p.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/TCGA/ESCA/os_2/" + gene + "_os.csv")
