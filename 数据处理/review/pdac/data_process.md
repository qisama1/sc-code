...
write.csv(as.matrix(scRNA[gene$gene, ]@assays$RNA@data), "/public/home/yuwenqi/sc-data/selected/review/pdac/gene_df.csv")
```
...
gene_df.groupby('cluster').mean().to_csv("/public/home/yuwenqi/sc-data/selected/review/pdac/gene_exp_cluster.csv")
```