data = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/subTME-heatmap-TAM-cancer/pdac/plot_data.csv", row.names=1)

an = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/subTME-heatmap-TAM-cancer/pdac/an.csv", row.names = 1)
...
pdf("/public/home/yuwenqi/sc-data/selected/append_ana/subTME-heatmap-TAM-cancer/pdac/pdac_heatmap-TAM.pdf", width = 10 , height = 10)
heatmap
dev.off()