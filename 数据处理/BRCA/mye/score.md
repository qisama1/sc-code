# 按照差异基因选
```python
meta = pd.read_csv("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/Mye/mye_meta.csv", index_col = 0)
mye_res = pd.read_csv("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/Mye/mye_res.csv", index_col=0, encoding = 'gbk')
marker = pd.read_csv("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/Mye/mye_markers_batched3.csv")
...
for i in sg.columns:
    ...
    res.to_csv("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/Mye/bc_mye_score/"+ i + "_pct.csv")
```