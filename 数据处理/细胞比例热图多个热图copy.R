...
bk <- c(seq(min(data), -0.001, (0 - min(data)) / 100), seq(min(data), -0.001, (0 - min(data)) / 100), seq(0, max(data), (max(data) - 0) / 100), seq(0, max(data), (max(data) - 0) / 100))
...
heatmap1 = pheatmap(data, 
                    ...
                    fontsize=10, # ????????????
                    #breaks = bk,
                    color = c(colorRampPalette(c("#0c00e6","#FFFFFF"))(length(bk) / 2), colorRampPalette(colors=c('#FFFFFF', '#e00000'))(length(bk) * 3 / 8), colorRampPalette(colors=c('#e00000'))(length(bk) / 8)), # ?????????????????????#color = colorRampPalette(c("#0c00e6",'#FFFFFF',"#e00000"))(100),
