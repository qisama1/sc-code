...
library(dplyr)
## bubble plot
data = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/DEG-singlecell/CRC/cellchat/DEG_cellchat.csv", row.names=1)
...
ggsave("/public/home/yuwenqi/sc-data/selected/append_ana/DEG-singlecell/CRC/cellchat/DEG_cellchat.pdf", plots, width = 4, height = 6, device = cairo_pdf, limitsize=F, units = 'in')
