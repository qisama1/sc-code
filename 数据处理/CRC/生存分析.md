```python
res = pd.read_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/crc_score_diff/res_stage.csv", index_col=0)
meta = pd.read_csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/COAD/coad_meta.csv", index_col=0)
...
clinical = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/COAD/os/os_meta.csv")
...
# 表达量数据
data = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/COAD/os/os_meta.csv", row.names=1)

marker <- c('subTME1', 'subTME2', 'subTME3')
...
data1 <- subset(data1,select= c(subTME1, subTME2, subTME3,Barcode))
...
ggsave(filename = "/public/home/yuwenqi/sc-data/selected/new-RNAseq/COAD/os/res/subTME1_os.pdf", device = 'pdf', width = 5, height = 5, units = 'in')
...
ggpar(ggsurvplot(
  ...
  legend = "top",
  font.legend = c(16, "bold"))
ggsave(filename = "/public/home/yuwenqi/sc-data/selected/new-RNAseq/COAD/os/res/subTME2_os.pdf", device = 'pdf', width = 5, height = 5, units = 'in')
...
ggpar(ggsurvplot(
  ...
  legend = "top",
  font.legend = c(16, "bold"))
ggsave(filename = "/public/home/yuwenqi/sc-data/selected/new-RNAseq/COAD/os/res/subTME3_os.pdf", device = 'pdf', width = 5, height = 5, units = 'in')
```
