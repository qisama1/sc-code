pbmc = qread("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/End/end.qs")

setwd("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/monocle/End/")
...
embed <- subset(embed, UMAP_1 > -2.5 & UMAP_1 < -2 & UMAP_2 > 2.5 & UMAP_2 < 3)
root.cell <- rownames(embed)
cds <- order_cells(cds, root_cells = root.cell)
pdf("./pseudotime_Venous_1.pdf")
