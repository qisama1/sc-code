...
data = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/PDAC/module/compare/PDAC_res_diff.csv", row.names=1)
...
ggsave(filename = "./pdac_module_stage.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
...
ggsave(filename = "./pdac_module_stage2.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
