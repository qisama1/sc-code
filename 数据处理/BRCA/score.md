...
for i in range(30) {
    for i in s_celltype.columns:
        ...
        if (major == 'End'):
            ...
            res = res.iloc[0:i,]
            s_celltype.loc['score', i] = res.mean().values[0]
    s_celltype.to_csv("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/BC3-CCI/module/cluster_sg_scores/s_celltype.csv")
    ...
    res.to_csv("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/BC3-CCI/module/cluster_sg_scores/s_res.csv")
}
