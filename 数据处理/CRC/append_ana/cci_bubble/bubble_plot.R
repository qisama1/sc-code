## bubble plot
data = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/cci-bubble/CRC/cellphonedb/bubble_base.csv", row.names=1)
sel_means=data
sel_pval=data
...
ggsave("/public/home/yuwenqi/sc-data/selected/append_ana/cci-bubble/CRC/cellphonedb/bubble_bc_cellphonedb.pdf", plot1, width = 10, height = 13, device = cairo_pdf, limitsize=F, units = 'in')
