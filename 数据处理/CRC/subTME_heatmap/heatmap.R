data = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/subTME-heatmap-TAM-cancer/crc/plot_data.csv", row.names=1)
an = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/subTME-heatmap-TAM-cancer/crc/an.csv", row.names = 1)
...
pdf("/public/home/yuwenqi/sc-data/selected/append_ana/subTME-heatmap-TAM-cancer/crc/crc_heatmap_TAM.pdf", width = 10, height = 10)
heatmap
dev.off()