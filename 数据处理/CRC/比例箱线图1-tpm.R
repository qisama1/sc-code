...
data = read.csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/crc_score_diff/res_stage.csv", row.names=1)
...
ggsave(filename = "./crc_module_stage1&2vs3&4.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
...
ggsave(filename = "./crc_module_stage1vs2&3&4.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
