...
```python
gene_df = pd.read_csv("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/BC3-CCI/module/module/gene_df.csv", index_col = 0)
meta = pd.read_csv("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/BC3-CCI/module/bc3_meta_all2.csv", index_col=0)

cellphonedb_cluster1 = ['Angiogenic_EC', 'ecm_myCAF']
cellphonedb_cluster2 = ['Cycling', 'ML_1', 'ecm_myCAF', 'Angiogenic_EC', 'Macro_SPP1']
pair = pd.read_csv("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/BC3-CCI/module/module/cci_an_sheet/cellphonedb_pair.csv")
...
cellchat_cluster1 = ['Angiogenic_EC', 'ecm_myCAF']
cellchat_cluster2 = ['Cycling', 'ML_1', 'ecm_myCAF', 'Macro_SPP1']
pair = pd.read_csv("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/BC3-CCI/module/module/cci_an_sheet/cellchat_pair.csv")
cols2 = []
...
```R
getwd()
setwd("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/BC3-CCI/module/module/cci_an_sheet/bubble/")
...
ggsave("./cellphonedb.pdf", width = 8, height = 10, device = cairo_pdf, limitsize=F, units = 'in')
