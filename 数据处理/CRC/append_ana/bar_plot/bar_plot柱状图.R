#柱状图
data = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/bar_plot/CRC/subTME1.csv")
p1 = ggplot(data = data,
...
data = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/bar_plot/CRC/subTME2.csv")
p2 = ggplot(data = data,
       aes(x = Description,y = Log.q.value.,fill = Description),
) +
  geom_bar(stat="identity", width=1, position = position_dodge(width = 1))+
...
data = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/bar_plot/CRC/subTME3.csv")
p3 = ggplot(data = data,
       aes(x = Description,y = Log.q.value.,fill = Description),
) +
  geom_bar(stat="identity", width=1, position = position_dodge(width = 1))+
...
ggsave("/public/home/yuwenqi/sc-data/selected/append_ana/bar_plot/CRC/CRC_subTME_barplot.pdf", plots, width = 4, height = 6, device = cairo_pdf, limitsize=F, units = 'in')
