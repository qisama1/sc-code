data = read.csv("/public/home/yuwenqi/sc-data/selected/subTME_heatmap/CRC/main_data.csv", row.names=1)
an = read.csv("/public/home/yuwenqi/sc-data/selected/subTME_heatmap/CRC/an.csv", row.names = 1)
...
pdf("/public/home/yuwenqi/sc-data/selected/subTME_heatmap/CRC/plot/crc_heatmap_all.pdf", width = 46, height = 35)
heatmap
dev.off()