...
for idx in gene_sub.index:
    ...
    p.to_csv("/public/home/yuwenqi/sc-data/selected/target-analysis-0403/PDAC/tcga_diff/" + gene_a + "_type.csv")
    p_t.to_csv("/public/home/yuwenqi/sc-data/selected/target-analysis-0403/PDAC/tcga_diff/" + gene_a + "_stage.csv")
    p_t2.to_csv("/public/home/yuwenqi/sc-data/selected/target-analysis-0403/PDAC/tcga_diff/" + gene_a + "_grade.csv")
    ...
    p_t.loc[:, ['stage', 'stage2']] = res_t.loc[p_t.index, ['stage', 'stage2']]
    p_t2.loc[:, ['grade', 'grade2']] = res_t2.loc[p_t2.index, ['grade', 'grade2']]
    p.to_csv("/public/home/yuwenqi/sc-data/selected/target-analysis-0403/PDAC/tcga_diff/" + gene_b + "_type.csv")
    p_t.to_csv("/public/home/yuwenqi/sc-data/selected/target-analysis-0403/PDAC/tcga_diff/" + gene_b + "_stage.csv")
    p_t2.to_csv("/public/home/yuwenqi/sc-data/selected/target-analysis-0403/PDAC/tcga_diff/" + gene_b + "_grade.csv")
...
for gene in gene_os.gene:
    ...
    p.to_csv("/public/home/yuwenqi/sc-data/selected/target-analysis-0403/PDAC/os/" + gene + "_os.csv")

```

```R
setwd("/public/home/yuwenqi/sc-data/selected/target-analysis-0403/PDAC/tcga_diff/")
fs = list.files('./', 'type')
