...
setwd("/public/home/yuwenqi/sc-data/selected/CRC/workspace/cluster-an/cox/crc/module_cluster_genes/subTME1/risk2/")
...
os_plot = function(data, filename, marker, data2) {
    ...
    dt_OS <- na.omit(dt_OS)
    dt_OS[dt_OS['risk'] > quantile(dt_OS$risk, 0.7), 'type'] = 'high'
