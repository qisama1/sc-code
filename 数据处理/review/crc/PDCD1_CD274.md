...
gene = c('PDCD1', 'CD274')
write.csv(as.matrix(scRNA[gene, ]@assays$RNA@data), "/public/home/yuwenqi/sc-data/selected/review/PDCD1_CD274/gene/crc_gene_df.csv")
```

# vinlin分析
```py
gene_df = pd.read_csv("/public/home/yuwenqi/sc-data/selected/review/PDCD1_CD274/gene/crc_gene_df.csv", index_col = 0)
gene_df = gene_df.T
...
gene_df.to_csv("/public/home/yuwenqi/sc-data/selected/review/PDCD1_CD274/violin/crc_data.csv")
```
# violinplot
```R
data = read.csv("/public/home/yuwenqi/sc-data/selected/review/PDCD1_CD274/violin/crc_data.csv")
...
ggsave("/public/home/yuwenqi/sc-data/selected/review/PDCD1_CD274/violin/crc_data_PDCD1.pdf", width = 2, height = 2.6, units = 'in')
...
p1=p1+theme(legend.position = "none",legend.background = element_blank(), legend.key = element_blank() ,legend.key.size = unit(0.5, "cm"), legend.title = element_blank(),
            panel.border = element_rect(linetype = 'solid', size = 0.3,fill = NA), text = element_text(size = 14) )
ggsave("/public/home/yuwenqi/sc-data/selected/review/PDCD1_CD274/violin/crc_data_CD274.pdf", width = 2, height = 2.6, units = 'in')
...
for cluster in clusters:
    ...
    t.to_csv("/public/home/yuwenqi/sc-data/selected/review/PDCD1_CD274/boxplot/" + cluster + "_crc.csv")   
```

# boxplot_tumor_normal
```R
setwd("/public/home/yuwenqi/sc-data/selected/review/PDCD1_CD274/boxplot/")
fs = list.files('./', '_crc.csv')
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/review/PDCD1_CD274/subTME_Diff/crc_plotdata.csv")
```
...
data = read.csv("/public/home/yuwenqi/sc-data/selected/review/PDCD1_CD274/subTME_Diff/crc_plotdata.csv", row.names=1)
...
ggsave("/public/home/yuwenqi/sc-data/selected/review/PDCD1_CD274/subTME_Diff/plot/crc_plot.pdf", width = 2, height = 2.6, units = 'in')
