# 处理p-v
```python
p = pd.read_csv("/public/home/yuwenqi/sc-data/selected/35/module/cellphonedb/module4/out/pvalues.txt", sep='\t', index_col=0)
v = pd.read_csv("/public/home/yuwenqi/sc-data/selected/35/module/cellphonedb/module4/out/means.txt", sep = '\t', index_col=0)
...
p.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cellphonedb/module4/p.csv")
v.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cellphonedb/module4/v.csv")
cnt.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/CRC1/cellchat/module1_df_net_cnt.csv")
```

```R
library(pheatmap)
setwd("/public/home/yuwenqi/sc-data/selected/35/module/cellchat/plot/")
count_matrix = read.csv("/public/home/yuwenqi/sc-data/selected/35/module/cellchat/module4_df_net_cnt.csv", row.names=1)
