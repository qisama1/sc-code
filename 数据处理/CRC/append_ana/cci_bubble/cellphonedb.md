```py
sub1 = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/cci-bubble/CRC/cellphonedb/sub1.csv")
sub2 = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/cci-bubble/CRC/cellphonedb/sub2.csv")
sub3 = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/cci-bubble/CRC/cellphonedb/sub3.csv")
...
pd.DataFrame(genes, columns = ['gene']).to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/cci-bubble/CRC/cellphonedb/gene_needed.csv")
# 构建结果列表
cols = []
for sub in [sub1, sub2, sub3]:
...
# 构建结果集，应该构建三个
data = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/cci-bubble/CRC/cellphonedb/gene_df.csv", index_col = 0).T
...
cellphonedb = pd.read_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/CRC1/cellphonedb/module2/v_filted.csv", index_col = 0)
for i in res2.index:
...
cellphonedb = pd.read_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/CRC1/cellphonedb/module3/v_filted.csv", index_col = 0)
for i in res3.index:
...
pd.concat([res1.loc[sorted_idx, res1.sum().sort_values(ascending=False).index], res2.loc[sorted_idx, res2.sum().sort_values(ascending=False).index], res3.loc[sorted_idx, res3.sum().sort_values(ascending=False).index]], axis=1).to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/cci-bubble/CRC/cellphonedb/bubble_base.csv")
```

```R
scRNA = qread("/public/home/yuwenqi/sc-data/selected/CRC/workspace/CRC1/crc1_used.qs")
gene = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/cci-bubble/CRC/cellphonedb/gene_needed.csv")
write.csv(as.matrix(scRNA[gene$gene, ]@assays$RNA@data), "/public/home/yuwenqi/sc-data/selected/append_ana/cci-bubble/CRC/cellphonedb/gene_df.csv")
```
```