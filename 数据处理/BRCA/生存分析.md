...
meta = pd.read_csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/BRCA/brca_meta.csv", index_col=0)
...
clinical = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/BRCA/os/os_res.csv")
...
# 表达量数据
data = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/BRCA/os/os_res.csv", row.names=1)
...
ggsave(filename = "/public/home/yuwenqi/sc-data/selected/new-RNAseq/BRCA/os/res/subTME1_os.pdf", device = 'pdf', width = 5, height = 5, units = 'in')
...
ggpar(ggsurvplot(
  ...
  legend = "top",
  font.legend = c(16, "bold"))
ggsave(filename = "/public/home/yuwenqi/sc-data/selected/new-RNAseq/BRCA/os/res/subTME2_os.pdf", device = 'pdf', width = 5, height = 5, units = 'in')
...
ggpar(ggsurvplot(
  ...
  legend = "top",
  font.legend = c(16, "bold"))
ggsave(filename = "/public/home/yuwenqi/sc-data/selected/new-RNAseq/BRCA/os/res/subTME3_os.pdf", device = 'pdf', width = 5, height = 5, units = 'in')
...
ggpar(ggsurvplot(
  ...
  legend = "top",
  font.legend = c(16, "bold"))
ggsave(filename = "/public/home/yuwenqi/sc-data/selected/new-RNAseq/BRCA/os/res/subTME4_os.pdf", device = 'pdf', width = 5, height = 5, units = 'in')
```
