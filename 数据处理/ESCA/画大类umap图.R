...
scRNA = qread("/public/home/yuwenqi/sc-data/selected/9/all2.qs")
meta = read.csv("/public/home/yuwenqi/sc-data/selected/9/plot_used.csv", row.names=1)
...
ggsave(filename = "/public/home/yuwenqi/sc-data/selected/9/esca_major_umap.pdf", plot = p1 | p2, device = 'pdf', width = 8, height = 4)