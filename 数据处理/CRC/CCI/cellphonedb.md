# 处理p-v
```python
p = pd.read_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/CRC1/cellphonedb/module3/out/pvalues.txt", sep='\t', index_col=0)
v = pd.read_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/CRC1/cellphonedb/module3/out/means.txt", sep = '\t', index_col=0)
...
for col in v.columns:
    ...
    cnt.loc[cluster2, cluster1] += t.loc[t > 0].count()

p.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/CRC1/cellphonedb/module3/p.csv")
v.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/CRC1/cellphonedb/module3/v.csv")
cnt.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/CRC1/cellphonedb/module3/cnt.csv")
```

```R
library(pheatmap)
setwd("/public/home/yuwenqi/sc-data/selected/CRC/workspace/CRC1/cellphonedb/module3/")
count_matrix = read.csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/CRC1/cellphonedb/module3/cnt.csv", row.names=1)
