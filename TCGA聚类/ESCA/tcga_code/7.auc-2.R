...
time_ROC.res<-data.frame(TP_1year=survival_ROC_1$TP, #获取3年的ROC的TP
                         ...
                         FP_5year=survival_ROC_5$FP) #获取10年的ROC的FP
...
TimeROC_plot<-ggplot()+
  ...
  annotate("text",x=0.75,y=0.25,size=4.5,
           label=paste0("AUC at 2 years = ",survival_ROC_AUC_3),color="blue") +
  annotate("text",x=0.75,y=0.20,size=4.5,
           label=paste0("AUC at 3 years = ",survival_ROC_AUC_5),color="black")+
