...
setwd("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/cluster-an/cox/module_cluster_genes/subTME2/")
fs = list.files('./', 'csv')
...
cox_cal = function(os_res, filename, gene_data) {
    ...
    write.csv(Unicox, paste0("/public/home/yuwenqi/sc-data/selected/Breast/workspace2/cluster-an/cox/module_cluster_genes/subTME2/cox_res/", filename, ".csv"))
}
