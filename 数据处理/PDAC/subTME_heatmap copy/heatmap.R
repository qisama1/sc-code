data = read.csv("/public/home/yuwenqi/sc-data/selected/subTME_heatmap/PDAC/heatmap.csv", row.names=1)
an = read.csv("/public/home/yuwenqi/sc-data/selected/subTME_heatmap/PDAC/an.csv", row.names = 1)
...
pdf("/public/home/yuwenqi/sc-data/selected/subTME_heatmap/PDAC/plot/crc_heatmap_all.pdf", width = 46, height = 35)
heatmap
dev.off()