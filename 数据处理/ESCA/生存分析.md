...
meta = pd.read_csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/ESCA/ESCA_meta.csv", index_col=0)
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/ESCA/os/os_meta.csv")
```
...
clinical = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/ESCA/os/os_meta.csv")
...
# 表达量数据
data = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/ESCA/os/os_meta.csv", row.names=1)
...
ggsave(filename = "/public/home/yuwenqi/sc-data/selected/new-RNAseq/ESCA/os/res/subTME1_os.pdf", device = 'pdf', width = 5, height = 5, units = 'in')
...
ggpar(ggsurvplot(
  ...
  legend = "top",
  font.legend = c(16, "bold"))
ggsave(filename = "/public/home/yuwenqi/sc-data/selected/new-RNAseq/ESCA/os/res/subTME2_os.pdf", device = 'pdf', width = 5, height = 5, units = 'in')
...
ggpar(ggsurvplot(
  ...
  legend = "top",
  font.legend = c(16, "bold"))
ggsave(filename = "/public/home/yuwenqi/sc-data/selected/new-RNAseq/ESCA/os/res/subTME3_os.pdf", device = 'pdf', width = 5, height = 5, units = 'in')
```
