...
data = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/ESCA/module/tpm_compare/tpm_module_grade.csv", row.names=1)
...
ggsave(filename = "./esca_subTME_grade1&2vs3.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
...
ggsave(filename = "./esca_subTME_grade1vs2&3.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
