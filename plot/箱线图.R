data = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/PDAC/tcga_gene_diff/plot_data1.csv", row.names=1)
...
ggsave("/public/home/yuwenqi/sc-data/selected/new-RNAseq/PDAC/tcga_gene_diff/pdac_tcga_gene_diff.pdf", width = 1.6, height = 2.6, units = 'in')

data = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/BRCA/CCI_res/tcga_gene_diff/plot_data2.csv", row.names=1)
data = melt(data, id.vars = c('type'))
...
p1=p1+theme(legend.position = c(0.8, 0.9), legend.background = element_blank(), legend.key = element_blank() ,legend.key.size = unit(0.2, "cm"), legend.title = element_blank(),
            panel.border = element_rect(linetype = 'solid', size = 0.3,fill = NA), text = element_text(size = 6) )
ggsave("/public/home/yuwenqi/sc-data/selected/new-RNAseq/PDAC/tcga_gene_diff/pdac_tcga_gene_diff2.pdf", width = 2.4, height = 2.6, units = 'in')