...
data = pd.read_csv("/public/home/yuwenqi/sc-data/selected/subTME_heatmap/PDAC/gene_df.csv", index_col = 0).T
...
pd.read_csv("/public/home/yuwenqi/sc-data/selected/35/module/cluster_sg_scores/s_celltype_gene_type.csv", index_col = 0).loc[:, ['type']].to_csv("/public/home/yuwenqi/sc-data/selected/subTME_heatmap/PDAC/an.csv")
```