import pandas as pd
gene_df = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/DEG-singlecell/PDAC/cellphonedb/gene_df.csv", index_col = 0).T
...
for idx in an_pair.index:
    ...
    if (cluster1 == 'CAF'):
        ...
        idx1 = meta.loc[meta.ident.str.contains(cluster1)].index
        meta_use = meta.loc[idx1,]
        idx1_T = meta_use.loc[idx1,].loc[meta_use['sample'].str.contains('T')].index
        idx1_N = meta_use.loc[idx1,].loc[meta_use['sample'].str.contains('N')].index
    if (cluster2 == 'CAF'):
        ...
        idx2 = meta.loc[meta.ident.str.contains(cluster2)].index
        meta_use = meta.loc[idx2, ]
        idx2_T = meta_use.loc[idx2,].loc[meta_use['sample'].str.contains('T')].index
        idx2_N = meta_use.loc[idx2,].loc[meta_use['sample'].str.contains('N')].index
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/DEG-singlecell/PDAC/cellphonedb/DEG_cellphonedb.csv") 