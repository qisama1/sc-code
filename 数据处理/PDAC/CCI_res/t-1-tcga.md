...
tcga.index = tcga.index.str[0]
gene = pd.read_csv("/public/home/yuwenqi/sc-data/selected/35/module/gene_needed2.csv")
...
res_t = pd.read_csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/PDAC/module/tpm-compare/tpm_module_stage.csv", index_col=0)
res_t2 = pd.read_csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/PDAC/module/tpm-compare/tpm_module_grade.csv", index_col=0)


cc = pd.read_csv("/public/home/yuwenqi/sc-data/selected/35/module/cellphonedb2.csv", index_col = 0)
for i in cc.index:
    for col in cc.columns:
      if (cc.loc[i, col] > 0):
        ...
        p.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/tcga_diff/cellphonedb/" + gene_a + "_type.csv")
        p_t.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/tcga_diff/cellphonedb/" + gene_a + "_stage.csv")
        p_t2.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/tcga_diff/cellphonedb/" + gene_a + "_grade.csv")
        ...
        p_t.loc[:, ['stage', 'stage2']] = res_t.loc[p_t.index, ['stage', 'stage2']]
        p_t2.loc[:, ['grade', 'grade2']] = res_t2.loc[p_t2.index, ['grade', 'grade2']]
        p.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/tcga_diff/cellphonedb/" + gene_b + "_type.csv")
        p_t.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/tcga_diff/cellphonedb/" + gene_b + "_stage.csv")
        p_t2.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/tcga_diff/cellphonedb/" + gene_b + "_grade.csv")
        if (flag):
            p = pd.DataFrame(tcga_use.loc[:, [gene_c]])
            p2 = pd.DataFrame(tcga_use.loc[:, [gene_c]])
            p2 = p2[~p2.index.duplicated()]
            p_t = p2.loc[res_t.index,]
            p_t2 = p2.loc[res_t2.index,]
            p.loc[:, 'type'] = res.loc[p.index, 'type']
            p_t.loc[:, ['stage', 'stage2']] = res_t.loc[p_t.index, ['stage', 'stage2']]
            p_t2.loc[:, ['grade', 'grade2']] = res_t2.loc[p_t2.index, ['grade', 'grade2']]
            p.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/tcga_diff/cellphonedb/" + gene_c + "_type.csv")
            p_t.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/tcga_diff/cellphonedb/" + gene_c + "_stage.csv")
            p_t2.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/tcga_diff/cellphonedb/" + gene_c + "_grade.csv")
...
for i in cc.index:
    for col in cc.columns:
      if (cc.loc[i, col] > 0):
        ...
        p.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/os/" + gene_a + "_os.csv")
        p = pd.DataFrame(tcga_use.loc[:, [gene_b]])
        p = pd.concat([p, os_res], axis=1)
        p.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/os/" + gene_b + "_os.csv")
        if (flag):
            p = pd.DataFrame(tcga_use.loc[:, [gene_c]])
            p = pd.concat([p, os_res], axis=1)
            p.to_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/os/" + gene_c + "_os.csv") 
```

```R
setwd("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/tcga_diff/cellchat/")
fs = list.files('./', 'type')
...
lapply(fs, function(x) {
    filename = str_split(x,'[.;]',simplify = T)[,1]
    data = read.csv(x)
    data=melt(data, id.vars=c('stage', 'stage2', 'Sample.ID'))
...
lapply(fs, function(x) {
    filename = str_split(x,'[.;]',simplify = T)[,1]
    data = read.csv(x)
    data=melt(data, id.vars=c('grade', 'grade2', 'Sample.ID'))
