...
write.csv(as.matrix(scRNA[gene$gene, ]@assays$RNA@data), "/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/PDAC/gene_df.csv")
```

# corr
```py
gene_df = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/PDAC/gene_df.csv", index_col=0).T
...
gene_df['sub_cluster'] = meta['ident']
gene_df['sample'] = meta['sample']
...
gsva_caf = pd.read_csv("/public/home/yuwenqi/sc-data/selected/35/module/cci_an_sheet/gsva_score/caf.csv", index_col = 0).T
...
idx = gsva_t.index[gsva_t.index.isin(meta_idx)]
gene_df.loc[idx, an_t.gene.dropna()].corr('spearman')
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/PDAC/corr_epi.csv")
idx = gsva_epi.index[gsva_epi.index.isin(meta_t.index)]
gene_df.loc[idx, an_t.gene.dropna()[an_t.gene.dropna().isin(gene_df.columns)]].corr(method = spearmanr_pval).to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/PDAC/corr_epi_gene.csv")
# Mye
...
meta_idx = meta_t[meta_t.ident.str.contains('Macro')].index
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/PDAC/corr_mye.csv")
idx = gsva_mye.index[gsva_mye.index.isin(meta_idx)]
gene_df.loc[idx, an_mye.gene.dropna()[an_mye.gene.dropna().isin(gene_df.columns)]].corr(method = spearmanr_pval).to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/PDAC/corr_mye_gene.csv")
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/PDAC/corr_epi_proliferation.csv")
idx = gsva_all.index[gsva_all.index.isin(meta_t.index)]
gene_df.loc[idx, an_t.gene.dropna()[an_t.gene.dropna().isin(gene_df.columns)]].corr(method = spearmanr_pval).to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/PDAC/corr_epi_proliferation_gene.csv")
