...
p1=p1+geom_point(aes(color=cell_type),position = position_jitterdodge(),size=1.0) +
  ...
  annotate("text", x = 'Macro_APOE/CTSZ', y =0.00020258, label='***', alpha=1) + #coord_cartesian(ylim = c(0.000180275, 0.000180317))+
...
p2=p2+geom_point(aes(color=cell_type),position = position_jitterdodge(),size=1.0) +
  scale_x_discrete(limits=c("Macro_APOE/CTSZ", "Macro_CXCL8", "Macro_CCL19", "Macro_FTL", "Macro_Pro","Mono")) +
  annotate("text", x = 'Macro_APOE/CTSZ', y =0.000258, label='***', alpha=1) + #coord_cartesian(ylim = c(0.0002, 0.0005))+
  theme(legend.position = 'none')
...
p3=p3+geom_point(aes(color=cell_type),position = position_jitterdodge(),size=1.0) +
  scale_x_discrete(limits=c("Macro_APOE/CTSZ", "Macro_CXCL8", "Macro_CCL19", "Macro_FTL", "Macro_Pro","Mono")) + coord_cartesian(ylim = c(0.0000, 0.0003))+
  annotate("text", x = 'Macro_APOE/CTSZ', y =0.00028, label='***', alpha=1) +
  theme(legend.position = 'none')
...
p4=p4+geom_point(aes(color=cell_type),position = position_jitterdodge(),size=1.0) +
  ...
  annotate("text", x = 'Macro_APOE/CTSZ', y =0.0001035, label='***', alpha=1) +
  theme(legend.position = 'none')
...
p5=p5+geom_point(aes(color=cell_type),position = position_jitterdodge(),size=1.0) +
  scale_x_discrete(limits=c("Macro_APOE/CTSZ", "Macro_CXCL8", "Macro_CCL19", "Macro_FTL", "Macro_Pro","Mono")) + coord_cartesian(ylim = c(0.000196, 0.00020))+
  annotate("text", x = 'Macro_APOE/CTSZ', y =0.0001998, label='***', alpha=1) + 
  theme(legend.position = 'none')
...
p6=p6+geom_point(aes(color=cell_type),position = position_jitterdodge(),size=1.0) +
  scale_x_discrete(limits=c("Macro_APOE/CTSZ", "Macro_CXCL8", "Macro_CCL19", "Macro_FTL", "Macro_Pro","Mono")) +
  annotate("text", x = 'Macro_APOE/CTSZ', y =0.0001269, label='***', alpha=1) +
  theme(legend.position = 'none')

p_all = plot_grid(p1, p2, p3, p4, p5, p6, nrow = 1)
ggsave(filename = "./mmrp_part4.pdf", plot = p_all, device = 'pdf', width = 15, height = 3.5, units = 'in')