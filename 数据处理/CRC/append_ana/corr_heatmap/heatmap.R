data = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr_heatmap/CRC/res_caf.csv", row.names=1)
...
heatmap = pheatmap(data, 
 ...
 pdf("/public/home/yuwenqi/sc-data/selected/append_ana/corr_heatmap/CRC/res_caf.pdf", width = 25, height = 25)
 heatmap
 dev.off()