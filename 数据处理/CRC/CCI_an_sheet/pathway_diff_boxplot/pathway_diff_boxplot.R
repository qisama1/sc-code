setwd("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_an_sheet/pathway_corr/gsva_diff/gsva_all/")
data_all = read.csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_an_sheet/pathway_corr/gsva_diff/gsva_all.csv")
data = data_all
