...
genes = pd.read_csv("/public/home/yuwenqi/targers_work/data_concat/check/all_genes.csv")
gene_list = []
g = set(genes.gene)
...
pd.DataFrame(gene_list, columns = ['gene']).to_csv("/public/home/yuwenqi/targers_work/data_process/genes.csv")
