import pandas as pd
gene_df = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/DEG-singlecell/ESCA/cellphonedb/gene_df.csv", index_col = 0).T
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/DEG-singlecell/ESCA/cellphonedb/DEG_cellphonedb.csv") 