...
for i in cc.index:
    for col in cc.columns:
      if (cc.loc[i, col] > 0):
        ...
        p.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_res/tcga_diff/cellchat/" + gene_a + "_type.csv")
        p_t.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_res/tcga_diff/cellchat/" + gene_a + "_grade.csv")
        p = pd.DataFrame(tcga_use.loc[:, [gene_b]])
        p_t = p.loc[res_t.index,]
        p.loc[:, 'type'] = res.loc[p.index, 'type']
        p_t.loc[:, ['stage', 'stage2']] = res_t.loc[p_t.index, ['stage', 'stage2']]
        p.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_res/tcga_diff/cellchat/" + gene_b + "_type.csv")
        p_t.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_res/tcga_diff/cellchat/" + gene_b + "_grade.csv")
        if (flag):
            p = pd.DataFrame(tcga_use.loc[:, [gene_c]])
            p_t = p.loc[res_t.index,]
            p.loc[:, 'type'] = res.loc[p.index, 'type']
            p_t.loc[:, ['stage', 'stage2']] = res_t.loc[p_t.index, ['stage', 'stage2']]
            p.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_res/tcga_diff/cellchat/" + gene_c + "_type.csv")
            p_t.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_res/tcga_diff/cellchat/" + gene_c + "_grade.csv")
...
for idx in cc.index:
    for col in cc.columns:
      if (cc.loc[idx, col] > 0):
        ...
        p.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_res/os/" + gene_a + "_os.csv")
        p = pd.DataFrame(tcga_use.loc[:, [gene_b]])
        p = pd.concat([p, os_res], axis=1)
        p.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_res/os/" + gene_b + "_os.csv")
```

```R
setwd("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/module/cci_res/tcga_diff/cellchat/")
fs = list.files('./', 'type')
