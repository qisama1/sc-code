...
gene = pd.read_csv("/public/home/yuwenqi/sc-data/selected/9/module/needed_gene.csv")
...
for i in cc.index:
    for col in cc.columns:
      if (cc.loc[i, col] > 0):
        ...
        p.to_csv("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/tcga_diff/cellphonedb/" + gene_a + "_type.csv")
        p_t.to_csv("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/tcga_diff/cellphonedb/" + gene_a + "_stage.csv")
        p_t2.to_csv("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/tcga_diff/cellphonedb/" + gene_a + "_grade.csv")
        ...
        p_t.loc[:, ['stage', 'stage2']] = res_t.loc[p_t.index, ['stage', 'stage2']]
        p_t2.loc[:, ['grade', 'grade2']] = res_t2.loc[p_t2.index, ['grade', 'grade2']]
        p.to_csv("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/tcga_diff/cellphonedb/" + gene_b + "_type.csv")
        p_t.to_csv("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/tcga_diff/cellphonedb/" + gene_b + "_stage.csv")
        p_t2.to_csv("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/tcga_diff/cellphonedb/" + gene_b + "_grade.csv")
        if (flag):
            ...
            p_t.loc[:, ['stage', 'stage2']] = res_t.loc[p_t.index, ['stage', 'stage2']]
            p_t2.loc[:, ['grade', 'grade2']] = res_t2.loc[p_t2.index, ['grade', 'grade2']]
            p.to_csv("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/tcga_diff/cellphonedb/" + gene_c + "_type.csv")
            p_t.to_csv("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/tcga_diff/cellphonedb/" + gene_c + "_stage.csv")
            p_t2.to_csv("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/tcga_diff/cellphonedb/" + gene_c + "_grade.csv")
...
for i in cc.index:
    for col in cc.columns:
      if (cc.loc[i, col] > 0):
        ...
        p.to_csv("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/os/" + gene_a + "_os.csv")
        p = pd.DataFrame(tcga_use.loc[:, [gene_b]])
        p = pd.concat([p, os_res], axis=1)
        p.to_csv("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/os/" + gene_b + "_os.csv")
        if (flag):
            p = pd.DataFrame(tcga_use.loc[:, [gene_c]])
            p = pd.concat([p, os_res], axis=1)
            p.to_csv("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/os/" + gene_c + "_os.csv") 
```

```R
setwd("/public/home/yuwenqi/sc-data/selected/9/module/cci_res/tcga_diff/celphonedb/")
fs = list.files('./', 'type')
