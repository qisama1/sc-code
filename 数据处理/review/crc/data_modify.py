...
data = pd.read_csv("/public/home/yuwenqi/sc-data/selected/review/crc/gene_exp_cluster.csv", index_col = 0)
...
n.to_csv("/public/home/yuwenqi/sc-data/selected/review/crc/heatmap_plot_data.csv")