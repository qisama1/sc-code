...
marker = pd.read_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/TNK/batch/cca/markers_batched2.csv")
...
for i in sg.columns:
    ...
    res.to_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/TNK/batch/cca/crc_tnk_score/"+ i + "_pct.csv")
```