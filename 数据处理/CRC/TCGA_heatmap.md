...
res = pd.read_csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/COAD/subTME_gsva_corr/plot_data.csv", index_col=0)

part1 = gsva.loc[:, ['Matrix remodeling', 'EMT', 'Immune Suppression by Myeloid Cells']]

an_gene = pd.read_csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/COAD/tcga_heatmap_all/an_gene.csv")
...
plot_data = pd.concat([res['module1'], data], axis=1)
...
plot_res[~plot_res.index.duplicated()].to_csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/COAD/tcga_heatmap_all/tcga_plot_data.csv")
```

```R
data = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/COAD/tcga_heatmap_all/tcga_plot_data.csv", row.names=1)
...
pdf("/public/home/yuwenqi/sc-data/selected/new-RNAseq/COAD/tcga_heatmap_all/coad_tcga_heatmap_all.pdf", width = 10, height = 10)
heatmap
dev.off()
