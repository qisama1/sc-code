data = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/4-12-tcga_heatmap-2/ESCA/heatmap_data.csv", row.names=1)
an = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/4-12-tcga_heatmap-2/ESCA/an.csv", row.names = 1)
...
pdf("/public/home/yuwenqi/sc-data/selected/append_ana/4-12-tcga_heatmap-2/ESCA/heatmap.pdf", width = 30, height = 10)
heatmap
dev.off()