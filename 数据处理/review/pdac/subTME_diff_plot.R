...
data = read.csv("/public/home/yuwenqi/sc-data/selected/review/pdac/subTME_diff_plot/plot_data.csv", row.names=1)
...
ggsave("/public/home/yuwenqi/sc-data/selected/review/pdac/subTME_diff_plot/subTME_diff_plot.pdf", width = 30, height = 2.6, units = 'in')
