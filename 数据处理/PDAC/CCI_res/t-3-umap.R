...
setwd("/public/home/yuwenqi/sc-data/selected/35/module/cci_res2/umap/cellphonedb/")
data = read.csv("/public/home/yuwenqi/sc-data/selected/35/module/cellphonedb2.csv", row.names=1)
