...
scRNA2 = qread("/public/home/yuwenqi/sc-data/selected/9/all.qs")
scRNA = scRNA[rownames(scRNA2), ]
qsave(scRNA, "/public/home/yuwenqi/sc-data/selected/35/all2.qs")
...
head(df.net)
write.csv(df.net, "/public/home/yuwenqi/sc-data/selected/35/module/cellchat/module4_df_net.csv")
#以通路为单位提取通讯信息
