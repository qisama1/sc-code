...
```python
df = pd.read_csv("/public/home/yuwenqi/sc-data/selected/38/score/tnk_df.csv", index_col=0)
...
tnk_res = pd.read_csv("/public/home/yuwenqi/sc-data/selected/38/score/tnk_res.csv", index_col=0)
...
for i in sg.columns:
    t = sg.loc[:, i]
    pd.DataFrame(t.sort_values(ascending = False)).to_csv("/public/home/yuwenqi/sc-data/selected/38/score/tnk/diff/sg" + i + "_pct.csv")
```