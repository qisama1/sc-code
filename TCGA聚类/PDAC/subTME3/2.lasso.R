...
lasso_cal = function(os_res, filename, unicox) {
    ...
    if (dim(unicox[1]) > 1) {
        ...
        pdf(paste0("/public/home/yuwenqi/sc-data/selected/35/cluster-an/cox/module_cluster_genes/subTME3/lasso/" , filename, "_" ,"lambda_plot_f1.pdf"),width=15,height=15)
        plot(f1, xvar="lambda",label=TRUE)
        dev.off()

        pdf(paste0("/public/home/yuwenqi/sc-data/selected/35/cluster-an/cox/module_cluster_genes/subTME3/lasso/" , filename, "_" ,"lambda_plot_cv.pdf"),width=15,height = 15)
        ...
        write.csv(genes, paste0("/public/home/yuwenqi/sc-data/selected/35/cluster-an/cox/module_cluster_genes/subTME3/lasso/" , filename, "_" ,"genes.csv"))
        ...
        res_path = paste0("/public/home/yuwenqi/sc-data/selected/35/cluster-an/cox/module_cluster_genes/subTME3/risk2/", filename, "_multicox.csv")
        ...
        if (k != 0) {
            ...
            res_path = paste0("/public/home/yuwenqi/sc-data/selected/35/cluster-an/cox/module_cluster_genes/subTME3/risk2/", filename, "_risk.csv")
...
setwd("/public/home/yuwenqi/sc-data/selected/35/cluster-an/cox/module_cluster_genes/subTME3/cox_res/")
