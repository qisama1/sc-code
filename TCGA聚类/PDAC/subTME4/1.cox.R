...
setwd("/public/home/yuwenqi/sc-data/selected/35/cluster-an/cox/module_cluster_genes/subTME4/")
fs = list.files('./', 'csv')
...
cox_cal = function(os_res, filename, gene_data) {
    ...
    write.csv(Unicox, paste0("/public/home/yuwenqi/sc-data/selected/35/cluster-an/cox/module_cluster_genes/subTME4/cox_res/", filename, ".csv"))
}
