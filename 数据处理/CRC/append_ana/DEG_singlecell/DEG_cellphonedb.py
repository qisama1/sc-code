import pandas as pd
gene_df = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/DEG-singlecell/CRC/cellphonedb/gene_df.csv", index_col = 0).T
...
for idx in an_pair.index:
    ...
    if (cluster1 == 'CAF'):
        ...
        idx1_T = meta_use.loc[idx1,].loc[meta_use.index.str.split('_').str[1] == 'T'].index
        idx1_N = meta_use.loc[idx1,].loc[meta_use.index.str.split('_').str[1] == 'N'].index
    elif (cluster1 == 'Epi'):
    ...
    if (cluster2 == 'CAF'):
        ...
        idx2_T = meta_use.loc[idx2,].loc[meta_use.index.str.split('_').str[1] == 'T'].index
        idx2_N = meta_use.loc[idx2,].loc[meta_use.index.str.split('_').str[1] == 'N'].index
    elif (cluster2 == 'Epi'):
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/DEG-singlecell/CRC/cellphonedb/DEG_cellphonedb.csv") 