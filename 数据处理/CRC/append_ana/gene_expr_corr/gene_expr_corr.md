...
write.csv(as.matrix(scRNA[gene$gene, ]@assays$RNA@data), "/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/CRC/gene_df.csv")
```

# corr
```py
gene_df = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/CRC/gene_df.csv", index_col=0).T
meta = pd.read_csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/CRC1/all3.csv", index_col=0)
meta_t = meta.loc[meta.index.str.split('_').str[1] == 'T']
gene_df = gene_df.loc[meta.index, ]
gene_df['sub_cluster'] = meta['sub_cluster']
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/CRC/corr_epi.csv")
idx = gsva_epi.index[gsva_epi.index.isin(meta_t.index)]
gene_df.loc[idx, an_t.gene.dropna()[an_t.gene.dropna().isin(gene_df.columns)]].corr(method = spearmanr_pval).to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/CRC/corr_epi_gene.csv")
# Mye
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/CRC/corr_mye.csv")
idx = gsva_mye.index[gsva_mye.index.isin(meta_idx)]
gene_df.loc[idx, an_mye.gene.dropna()[an_mye.gene.dropna().isin(gene_df.columns)]].corr(method = spearmanr_pval).to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/CRC/corr_mye_gene.csv")
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/CRC/corr_epi_proliferation.csv")
idx = gsva_all.index[gsva_all.index.isin(meta_t.index)]
gene_df.loc[idx, an_t.gene.dropna()[an_t.gene.dropna().isin(gene_df.columns)]].corr(method = spearmanr_pval).to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr-gene-score/CRC/corr_epi_proliferation_gene.csv")
