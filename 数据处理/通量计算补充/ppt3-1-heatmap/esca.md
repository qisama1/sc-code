...
res.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/pathway_appends/PPT3-1-heatmap/esca/plot_data.csv")
```

```R
data = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/pathway_appends/PPT3-1-heatmap/esca/plot_data.csv", row.names=1)
...
ggsave(filename = "/public/home/yuwenqi/sc-data/selected/append_ana/pathway_appends/PPT3-1-heatmap/esca/plot.pdf", plot = heatmap, device = 'pdf', width = 10, height = 10, units = 'in')
```