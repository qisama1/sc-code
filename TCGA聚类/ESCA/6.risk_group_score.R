data_risk = read.csv("/public/home/yuwenqi/sc-data/selected/9/cluster-an/cox/module_cluster_genes/subTME2/risk2/all_risk.csv", row.names=1)
...
setwd("/public/home/yuwenqi/sc-data/selected/9/cluster-an/cox/module_cluster_genes/subTME2/risk_group_score/")
