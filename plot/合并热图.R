...
data1=read.csv('./lc1_pro.csv',row.names=1)

data2=read.csv('./lc2_pro.csv',row.names=1)

data3=read.csv('./mmrd_pro.csv',row.names=1)

data4=read.csv('./mmrp_pro.csv',row.names=1)

data5=data.frame(data1,data2,data3,data4)
colnames(data5) = c('LungData1','LungData2', 'CRC_MMRd', 'CRC_MMRp')
colnames(data5) = rep(colnames(data1), 4)
