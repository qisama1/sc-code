setwd("/public/home/yuwenqi/sc-data/selected/new-RNAseq/BRCA/module/tpm_compare/plot/")
data = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/BRCA/module/tpm_compare/tpm_module_stage.csv", row.names=1)
data=melt(data, id.vars=c('type','stage', 'stage2'))
...
ggsave(filename = "./brca_module_stage1&2vs3&4.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
...
ggsave(filename = "./plot/brca_module_stage1vs2&3&4.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
