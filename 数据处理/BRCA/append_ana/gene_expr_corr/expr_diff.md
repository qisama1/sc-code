...
write.csv(as.matrix(scRNA[gene$gene, ]@assays$RNA@data), "/public/home/yuwenqi/sc-data/selected/append_ana/gene_exp/BC/gene_df.csv")
```
...
for i in gene_used.index:
    ...
    if (v.type == 'TAM'):
        ...
        res.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/gene_exp/BC/gene/" + v.type + "_" + g + ".csv")
    if (v.type == 'CD8+T'):
