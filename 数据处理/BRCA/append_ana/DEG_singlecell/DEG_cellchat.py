import pandas as pd
gene_df = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/DEG-singlecell/BC/cellchat/gene_df.csv", index_col = 0).T
an_pair = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/DEG-singlecell/BC/cellchat/an_pair.csv")
...
for idx in an_pair.index:
    ...
    if (cluster1 == 'CAF'):
        ...
        idx1 = meta.loc[meta.sub_cluster.str.contains('Macro')]
        idx1_T = meta.loc[idx1,].loc[meta.Tissue == 'Tumor'].index
        idx1_N = meta.loc[idx1,].loc[meta.Tissue == 'Normal'].index
    elif (cluster1 == 'CD8Teff'):
        idx1 = meta.loc[meta.sub_cluster.str.contains("CD8")]
        idx1_T = meta.loc[idx1,].loc[meta.Tissue == 'Tumor'].index
        idx1_N = meta.loc[idx1,].loc[meta.Tissue == 'Normal'].index
    else:
        idx1 = meta.loc[meta.sub_cluster == cluster1]
    ...
    if (cluster2 == 'CAF'):
        ...
        idx2 = meta.loc[meta.sub_cluster.str.contains('Macro')]
        idx2_T = meta.loc[idx2,].loc[meta.Tissue == 'Tumor'].index
        idx2_N = meta.loc[idx2,].loc[meta.Tissue == 'Normal'].index
    elif (cluster2 == 'CD8Teff'):
        idx2 = meta.loc[meta.sub_cluster.str.contains("CD8")]
        idx2_T = meta.loc[idx2,].loc[meta.Tissue == 'Tumor'].index
        idx2_N = meta.loc[idx2,].loc[meta.Tissue == 'Normal'].index
    else:
        idx2 = meta.loc[meta.sub_cluster == cluster2]
        idx2_T = meta.loc[idx2,].loc[meta.Tissue == 'Tumor'].index
        idx2_N = meta.loc[idx2,].loc[meta.Tissue == 'Normal'].index
...
res.to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/DEG-singlecell/BC/cellchat/DEG_cellchat.csv") 