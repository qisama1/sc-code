...
p2=p2+geom_point(aes(color=cell_type),position = position_jitterdodge(),size=1.0) +
  scale_x_discrete(limits=c("Macro_APOE/CTSZ", "Macro_CXCL8", "Macro_CCL19", "Macro_FTL", "Macro_Pro","Mono")) + coord_cartesian(ylim = c(0.00000001, 0.0000003))+
  annotate("text", x = 'Macro_APOE/CTSZ', y =0.00000028, label='***', alpha=1) + 
  theme(legend.position = 'none')
...
p4=p4+geom_point(aes(color=cell_type),position = position_jitterdodge(),size=1.0) +
  scale_x_discrete(limits=c("Macro_APOE/CTSZ", "Macro_CXCL8", "Macro_CCL19", "Macro_FTL", "Macro_Pro","Mono")) + coord_cartesian(ylim = c(0.0, 0.02))+
  annotate("text", x = 'Macro_APOE/CTSZ', y =0.018, label='***', alpha=1) +
  theme(legend.position = 'none')
...
p6=p6+geom_point(aes(color=cell_type),position = position_jitterdodge(),size=1.0) +
  scale_x_discrete(limits=c("Macro_APOE/CTSZ", "Macro_CXCL8", "Macro_CCL19", "Macro_FTL", "Macro_Pro","Mono")) + coord_cartesian(ylim = c(0.0, 0.004))+
  annotate("text", x = 'Macro_APOE/CTSZ', y =0.003, label='***', alpha=1) +
  theme(legend.position = 'none')
...
p7=p7+geom_point(aes(color=cell_type),position = position_jitterdodge(),size=1.0) +
  scale_x_discrete(limits=c("Macro_APOE/CTSZ", "Macro_CXCL8", "Macro_CCL19", "Macro_FTL", "Macro_Pro","Mono")) + 
  annotate("text", x = 'Macro_APOE/CTSZ', y =0.000000444, label='***', alpha=1) +
  theme(legend.position = 'none')
...
p8=p8+geom_point(aes(color=cell_type),position = position_jitterdodge(),size=1.0) +
  scale_x_discrete(limits=c("Macro_APOE/CTSZ", "Macro_CXCL8", "Macro_CCL19", "Macro_FTL", "Macro_Pro","Mono")) +
  annotate("text", x = 'Macro_APOE/CTSZ', y =0.0000769, label='***', alpha=1) + #coord_cartesian(ylim = c(0.000072, 0.000074))+
  theme(legend.position = 'none')

p_all = plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, nrow = 1)
ggsave(filename = "./mmrp_part1.pdf", plot = p_all, device = 'pdf', width = 25, height = 3.5, units = 'in')