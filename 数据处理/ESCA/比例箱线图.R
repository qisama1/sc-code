...
data = read.csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/ESCA/module/compare/ESCA_res_diff.csv", row.names=1)
...
ggsave(filename = "./esca_module_stage.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
...
ggsave(filename = "./esca_module_stage2.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
