...
an_gene = pd.read_csv("/public/home/yuwenqi/sc-data/selected/append_ana/4-12-tcga_heatmap-2/ESCA/an_gene.csv")
gsva = pd.read_csv("/public/home/yuwenqi/sc-data/selected/new-RNAseq/ESCA/ssgsea/esca_ssgsva.csv", index_col = 0).T
...
corr_res2.columns = ['EMT','Immune_escape', 'Pro_inflammatory', 'Matrix_remodeling', 'Angiogenesis', 'Tumor_proliferation', 'Hypoxia', 'Cellular_senescence']
...
basic_res[~basic_res.index.duplicated()].to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/4-12-tcga_heatmap-2/ESCA/heatmap_data.csv")

res.loc[:, ['type']].to_csv("/public/home/yuwenqi/sc-data/selected/append_ana/4-12-tcga_heatmap-2/ESCA/an.csv")
