setwd("/public/home/yuwenqi/sc-data/selected/35/module/cluster_sg_scores/s_celltype_gene_compare/")
data = read.csv("/public/home/yuwenqi/sc-data/selected/35/module/cluster_sg_scores/s_celltype_gene_type.csv", row.names=1)
data=melt(data, id.vars=c('type'))
data=melt(data, id.vars=c('stage'))
...
ggsave(filename = "./35_subtme_gene_type.pdf", plot = p1, device = 'pdf', width = 4, height = 3.5, units = 'in')
...
ggsave(filename = "./35_subtme_type.pdf", plot = p1, device = 'pdf', width = 4, height = 3.5, units = 'in')
