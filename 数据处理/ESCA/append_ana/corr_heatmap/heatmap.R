data = read.csv("/public/home/yuwenqi/sc-data/selected/append_ana/corr_heatmap/ESCA/res_epi.csv", row.names=1)
...
heatmap = pheatmap(data, 
 ...
 pdf("/public/home/yuwenqi/sc-data/selected/append_ana/corr_heatmap/ESCA/res_epi.pdf", width = 25, height = 25)
 heatmap
 dev.off()