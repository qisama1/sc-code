setwd("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/cluster_sg_gene_score/plot/")
data = read.csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/cluster_sg_gene_score/s_celltype_res_grade.csv", row.names=1)
data=melt(data, id.vars=c('grade', 'node_type', 'type'))
...
ggsave(filename = "./crc_gene_subTME_grade.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
...
ggsave(filename = "./crc_gene_subTME_node_type.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')



setwd("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/cluster_sg_gene_score/plot/")
data = read.csv("/public/home/yuwenqi/sc-data/selected/CRC/workspace/module/cluster_sg_gene_score/s_celltype_res_type.csv", row.names=1)
...
ggsave(filename = "./crc_gene_subTME_type.pdf", plot = p1, device = 'pdf', width = 6, height = 3.5, units = 'in')
